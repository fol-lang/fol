...
pub(crate) const V3_MEM_M2_POSITIVES: &[V3PositiveExample] = &[
    ...
    ("examples/mem_nested_receiver_call_m2", Some("42\n")),
...
pub(crate) const V3_PROC_M3_POSITIVES: &[V3PositiveExample] = &[
    ...
    ("examples/proc_mutex_local_loop_m3", Some("3\n")),
...
pub(crate) const V3_MEM_M1_FAILURES: &[V3FailureExample] = &[
    ...
    v3_failure!(
        ...
        "T1002",
        "holds a 'fin' value buried inside 'vec[Holder]'",
        false,
        false
    ),
    v3_failure!(
...
pub(crate) const V3_PROC_M4_FAILURES: &[V3FailureExample] = &[
    ...
    v3_failure!(
        ...
        "O1001",
        "an eventual received as parameter 'handle' must name its parent-scope lifetime",
        true,
        false
    ),
    v3_failure!(
...
pub(crate) const V3_NAVIGATION_PROBES: &[V3NavigationProbe] = &[
    ...
    ("examples/mem_nested_receiver_call_m2", "tally", 2, Some(14)),
    ...
    ("examples/mem_fin_field_m1", "pair", 2, Some(24)),
    ...
    ("examples/proc_mutex_local_loop_m3", "state", 2, None),
