module.exports = grammar({
  ...
  rules: {
    ...
    std_decl: $ => seq('std', optional(field('modifiers', $.decl_modifiers)), field('name', $.identifier), ':', field('kind', choice('pro', 'blu', 'ext')), '=', $.block),
    ...
    plain_pro_decl: $ => seq(field('name', $.identifier), $.params, optional($.return_type), optional($.error_type), '=', $.block),
