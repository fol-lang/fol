...
(dot_intrinsic name: (identifier) @function.builtin
  (#match? @function.builtin "^(eq|nq|lt|gt|ge|le|not|len|echo|write|read_key|raw_mode|sleep_ms|now_ms|term_cols|term_rows|int_to_str|str_sub|str_byte|byte_to_str|read_key_ms)$"))
