...
fn editor_command_plain_output_stays_snapshot_stable_for_real_fixtures() {
    ...
    assert_eq!(
        rendered,
        format!(
            "command: symbols\nsummary: tree-sitter symbol query matched 14 symbols in 14 scopes (error_count=0, lines=64, missing_count=0, named_node_count=415, node_count=666, parse_status=ok, path={}, query_bytes=1022, root_kind=source_file, scope_count=14, symbol=symbol.function@19:9-19:13:make, symbol=symbol.function@27:9-27:23:enable_verbose, symbol=symbol.function@35:9-35:19:level_code, symbol=symbol.function@39:9-39:19:level_name, symbol=symbol.function@48:9-48:15:allows, symbol=symbol.function@52:9-52:13:emit, symbol=symbol.function@61:9-61:21:emit_default, symbol=symbol.type@0:4-0:9:Level, symbol=symbol.type@7:9-7:15:Logger, symbol=symbol.variable@13:9-13:16:DEFAULT, symbol=symbol.variable@2:9-2:14:DEBUG, symbol=symbol.variable@3:9-3:13:INFO, symbol=symbol.variable@4:9-4:13:WARN, symbol=symbol.variable@5:9-5:14:ERROR, symbol_count=14, symbol_kinds=symbol.function,symbol.type,symbol.variable)",
